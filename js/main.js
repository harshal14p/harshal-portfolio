...
function initContactActions(){
  ...
  wa.className="btn btn-ghost contact-glass-action contact-whatsapp"; wa.href=getWhatsAppHref(); wa.target="_blank"; wa.rel="noopener noreferrer"; wa.setAttribute("data-cursor","link"); wa.setAttribute("aria-label","Chat with Harshal on WhatsApp"); wa.innerHTML=`${iconWhatsApp()}<span>Chat Now</span>`;

  if(!document.getElementById("contact-action-style")){const style=document.createElement("style");style.id="contact-action-style";style.textContent=`
    ...
    .contact-whatsapp .contact-icon{color:#62e28a}.contact-actions a[href^="tel:"] .contact-icon{color:#bba7ff}.contact-actions [data-bind="email-link"] .contact-icon{color:#fff}.contact-actions [data-bind="linkedin-link"] .contact-icon{color:#67aafc}
